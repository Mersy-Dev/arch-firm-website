...
const OFFICES = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1518005020951-eccb494ad742?w=900&q=80&fit=crop",
  },
  {
    flag: "DXB",
    city: "Dubai",
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(7,17,26,0.4) 0%, rgba(7,17,26,0.3) 30%, rgba(7,17,26,0.78) 65%, rgba(7,17,26,0.98) 100%)",
        }}
      />
      ...
      <div className="container-main absolute inset-0 flex flex-col justify-between py-10 md:py-14">
        ...
        <motion.div style={{ y: textY }}>
          ...
          <h1
            ...
            style={{ margin: "0 0 1.8rem", lineHeight: 0.95 }}
          >
            {["Start", "a", "conversation."].map((word, i, arr) => (
              <motion.span
                ...
                style={{
                  ...
                  lineHeight: 0.9,
                  color:
                    i === arr.length - 1 ? "rgba(255,255,255,0.3)" : "white",
            ...
            {ENQUIRY_TYPES.map((type) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  onClick={() =>
                    setForm((f) => ({ ...f, enquiry: active ? "" : type }))
                  }
                  style={{
                    fontFamily: "var(--font-body)",
                    fontSize: "0.68rem",
            ...
            {BUDGET_RANGES.map((range) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  onClick={() =>
                    setForm((f) => ({ ...f, budget: active ? "" : range }))
                  }
                  style={{
                    fontFamily: "var(--font-body)",
                    fontSize: "0.68rem",
      ...
      <div className="relative z-10 p-8 md:p-10 lg:p-12 flex flex-col h-full">
        ...
        >
          ...
          >
            Three{" "}
            <em
              style={{ fontStyle: "italic", color: "rgba(255,255,255,0.36)" }}
            >
              cities
            </em>
          </h2>
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  >
                    <motion.svg
                      ...
                      fill="none"
                      stroke={
                        isActive ? "var(--color-gold)" : "rgba(255,255,255,0.4)"
                      }
                      strokeWidth="1.5"
        ...
        >
          <AnimatePresence mode="wait">
            ...
            >
              <img
                src={OFFICES[active].image}
                alt={OFFICES[active].city}
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to top, rgba(26,60,94,0.7) 0%, transparent 55%)",
                }}
                aria-hidden="true"
              />
              {/* Gold corner bracket */}
